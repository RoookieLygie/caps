          ...
          if(mysqli_num_rows($selecting)>0){
            ...
            <tr>
                ...
                <td class="payment-status" id="paidStatus1">
                   ...
                   echo '<a style="font-size:12px;" class="paid-status" href="book_2.php?sourceurl='.uniqid().uniqid().uniqid().uniqid().rand(111111111,99999999).'&alt='.uniqid().uniqid().'&id=' . $row["id"] .'&'.uniqid().uniqid(). '">Make Payment</a>';
                    ...
                    echo "<p class='cancel-status'>Rejected</p>";
                      ...
                      echo '<p class="paid-status">Pending</p>';
                   } ?> 
                </td>
                <td class="action-buttons">

                    <a style='text-align:center;' class="view-button" href='<?php echo $row['package'].".php"; ?>'>View</a>
...
<button class="share-button" onclick="copyLink(this, '<?php echo $row['package']; ?>')">Copy Link To Share</button>
