...
<body>
 ...
 $query = "SELECT * FROM reserve_booking2 WHERE status = '1' OR status='2'";
...
if(($row['package'])==''){
    echo 'Iterinary Booking';
                    ...
                    ?>
                    <img width="150px" src="<?php echo $row['package'].".png"; ?> "alt="Wishlist Image" onclick="openPopup('<?php echo $row['package'].".png"; ?>')"></td>
