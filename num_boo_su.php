        ...
        <div class="row">
            <div class="col-lg-12 m-b30">
                ...
                <div class="heading-bx left">
                    <h2 class="m-b10 title-head">Transactions <span>History</span></h2>
                </div>
                <section>
                    <style>
                        table {
...
<body>
 ...
 $query = "SELECT * FROM reserve_booking2 WHERE  status='2'";
    ...
    while($row=mysqli_fetch_array($result)){
            ...
            <tr>
                ...
                <td>   <?php  if(($row['package'])==''){
                    ...
                    ?></td>
                <td><?php    
                if(($row['payments'])== 'paid'){
                    echo $row['p_date'];
                }else{
                    echo 'Accepted but hasnt paid';
                }
                ?></td>
                <td><?php    
                if(($row['payments'])== 'paid'){
