        ...
        <div class="row">
            <div class="col-lg-12 m-b30">
                ...
                <div class="heading-bx left">
                    <h2 class="m-b10 title-head">Wish <span>List</span></h2>
                </div>
                <section>
                    <style>
                        table {
...
<body>
 ...
 $query = "SELECT * FROM wishlist WHERE user = $userId AND status='1'";
 ...
 $a+1;
    while($row=mysqli_fetch_array($result)){
            ...
            <tr>
                ...
                <td><img width="150px" src="<?php echo $row['carname'].".png"; ?> "alt="Wishlist Image" onclick="openPopup('<?php echo $row['carname'].".png"; ?>')"></td>
                <td>2023-01-15</td>
                <td class="action-buttons">
                    
                    <!-- <button class="view-button" onclick="viewAction(1)">View</button> -->
                    <a class="view-button" href='<?php echo $row['carname'].".php"; ?>'>View</a>
