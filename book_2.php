...
<!-- <a style='text-decoration:none;' href="book_3.php?id=<?php //echo $row["id"]; ?>" class="reservation">PAYMENT TO PROCESS</a> -->
<a style='text-decoration:none;' href="Payment.php?id=<?php echo $row["id"]; ?>" class="reservation">Make Payment of (<?php echo $row['price'] ;  ?>)</a>
    </form>
</body>
</html>
<?php  ?>
