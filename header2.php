...
if(!isset($_SESSION['logi'])){
 ...
 $select=mysqli_query($db, "SELECT * FROM admin WHERE email='$email'");
            ...
            <div class="ttr-logo-box">
                <div>
                    <a href="index.php" class="ttr-logo">
					    <img alt="" class="ttr-logo-mobile" src="IMAGES/DAYO LOGO.png" style="width: 200px; height: 36px;">
						<img alt="" class="ttr-logo-desktop" src="IMAGES/DAYO LOGO.png" style="width: 200px; height: 36px;">
					</a>
                </div>
            </div>
                    ...
                    <li>
                        ...
                        <div class="ttr-header-submenu noti-menu">
                            ...
                            <div class="noti-box-list">
                                <ul>
                                <a href="Profile2.php" style="text-decoration: none;color: black;">
                                        <li>
                                    ...
                                    <a href="num_book.php" style="text-decoration: none;color: black;">
                                        <li>
                                    ...
                                    <hr>
                                    <a href="num_boo_su.php" style="text-decoration: none;color: black;">
                                        <li>
